      ...
      html: `
        ...
        <head>
          <style>
            ...
            .header { background: linear-gradient(135deg, #FF9933 0%, #FF6600 100%); color: white; padding: 20px; text-align: center; border-radius: 10px; margin-bottom: 20px; }
            .content { background: #f9f9f9; padding: 20px; border-radius: 10px; }
            .info-row { background: white; padding: 12px; margin: 10px 0; border-radius: 6px; border-left: 4px solid #33A9FF; }
            .label { font-weight: bold; color: #666; }
            .value { color: #333; margin-left: 10px; }
            .button { display: inline-block; padding: 12px 30px; background: #33A9FF; color: white !important; text-decoration: none; border-radius: 25px; font-weight: bold; margin-top: 15px; }
          </style>
        </head>
        <body>
          <div class="header">
            <h2 style="margin: 0;">🔔 New Beta Signup!</h2>
          </div>
          <div class="content">
            <div class="info-row">
            ...
            <div class="info-row">
              <span class="label">👥 Total Testers:</span>
              <span class="value">${betaTesters.length}</span>
            </div>
            <center>
              <a href="https://nutriai.online/beta-admin" class="button">View Admin Panel →</a>
            </center>
          </div>
        </body>
        </html>
