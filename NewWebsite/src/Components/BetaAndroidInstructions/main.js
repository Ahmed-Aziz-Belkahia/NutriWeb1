...
export default function BetaAndroidInstructions() {
  return (
    <div>
      <Headerr />
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12">
              <div className="banner_text" style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto' }}>
                ...
                <h1>
                  Welcome to the <span>NutriAI Android Beta</span>
                </h1>
              ...
              <div className="row_am" style={{ marginBottom: '40px' }}>
                ...
                <div className="text">
                  ...
                  <p style={{ marginBottom: '25px', fontSize: '16px', lineHeight: '1.7', color: '#666' }}>
                    Click the button below to join the NutriAI beta testing program on Google Play. You'll be able to download and test the app.
                  </p>
                  <div style={{ textAlign: 'center' }}>
                    <a 
                      href="https://play.google.com/apps/testing/com.nutritheapp.nutriai"
                      target="_blank"
